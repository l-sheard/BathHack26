  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="relative mx-auto max-w-2xl py-12">
        <Card className="space-y-6 bg-white/15 backdrop-blur-md shadow-lg text-black rounded-3xl">
          ...
          {loading ? (
            ...
            <div className="text-center text-black">No trips found.</div>
          ) : (
            <ul className="space-y-3">
              {trips.map((trip) => (
                <li
                  key={trip.id}
                  className="rounded-xl bg-white/5 px-4 py-3 text-black shadow cursor-pointer hover:bg-violet-500/10 transition"
