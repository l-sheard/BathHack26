...
const GENERATION_STEPS = [
  {
    id: "gather-preferences",
    title: "Gathering preferences",
    description: "Collecting constraints from all participants...",
  },
  {
    id: "find-dates",
    title: "Finding overlapping dates",
    description: "Determining when everyone is available...",
  },
  {
    id: "select-destination",
    title: "Selecting destinations",
    description: "Analyzing and ranking destination options...",
  },
  {
    id: "plan-transport",
    title: "Planning transport",
    description: "Finding flights and trains for each participant...",
  },
  {
    id: "find-accommodation",
    title: "Finding accommodation",
    description: "Selecting hotels and stays matching preferences...",
  },
  {
    id: "arrange-dining",
    title: "Arranging dining",
    description: "Curating restaurants for dietary requirements...",
  },
  {
    id: "check-visas",
    title: "Checking visas",
    description: "Assessing visa requirements for all nationalities...",
  },
  {
    id: "save-results",
    title: "Saving results",
    description: "Storing trip options in your dashboard...",
  },
];
...
export function GenerationPage() {
  ...
  useEffect(() => {
    const fallbackStep = progressSteps.find(
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="relative mx-auto max-w-2xl py-12">
        ...
        >
          <Card className="space-y-8 bg-white/15 backdrop-blur-md shadow-lg text-black rounded-3xl">
                    ...
                    <div className="space-y-1.5">
                      ...
                      {isActive && (
                        <div className="mt-2 space-y-1">
                          ...
                          <p className="text-xs text-black pl-1">
                            {
                              STEP_THOUGHT_PROMPTS[step.id]?.[
                                thoughtIndex %
                                  Math.max(
                                    1,
                                    STEP_THOUGHT_PROMPTS[step.id]?.length ?? 1,
                                  )
                              ]
                            }
                          </p>
              ...
              <div className="grid gap-4 md:grid-cols-3">
                <div>
                  ...
                  <div className="text-2xl font-bold text-black">
                    {
                      progressSteps.filter((s) => s.status === "complete")
                        .length
                    }
                ...
                <div>
                  <div className="text-sm text-black mb-1">Current Step</div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-emerald-900">
                      Trip options generated successfully!
                    </p>
                    <p className="text-sm text-emerald-700 mt-1">
                      Your AI agents have created 3 personalized trip options.
